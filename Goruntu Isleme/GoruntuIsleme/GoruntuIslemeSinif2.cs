...
{
	 public static class Resimİsleme2
    {
        ...
        public static Bitmap Laplacian3x3Filter(this Bitmap sourceBitmap, 
                                                    bool grayscale = true)
        {
            Bitmap resultBitmap = Resimİsleme2.ConvolutionFilter(sourceBitmap, 
                                    Matris.Laplacian3x3, 1.0, 0, grayscale);
        ...
        {
            Bitmap resultBitmap = Resimİsleme2.ConvolutionFilter(sourceBitmap, 
                                    Matris.Laplacian5x5, 1.0, 0, grayscale);
        ...
        {
            Bitmap resultBitmap = Resimİsleme2.ConvolutionFilter(sourceBitmap, 
                                                 Matris.Sobel3x3Horizontal, 
                                                   Matris.Sobel3x3Vertical, 
                                                        1.0, 0, grayscale);
        ...
        {
            Bitmap resultBitmap = Resimİsleme2.ConvolutionFilter(sourceBitmap, 
                                               Matris.Prewitt3x3Horizontal, 
                                                 Matris.Prewitt3x3Vertical, 
                                                        1.0, 0, grayscale);
